...
public class fragment_main_equipment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_main_equipment, container, false);
        initdata();
        initContrls(v);
        return v;
    }
    ...
    private void initContrls(View v) {
        ...
        recyclerView = (RecyclerView) v.findViewById(R.id.fragment_equiment_my_recycler_view);
